...
class DataRowsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $dataTypeProducts = DataType::where('slug', 'products')->firstOrFail();

        // Create data rows for the products table
        $this->createDataRow($dataTypeProducts, 'id', 'number', 'ID', true, false, false, false, false, 1);
        $this->createDataRow($dataTypeProducts, 'name', 'text', 'Name', true, true, true, true, true, 2);
        $this->createDataRow($dataTypeProducts, 'details', 'text', 'Details', true, true, true, true, true, 3);
        $this->createDataRow($dataTypeProducts, 'description', 'text', 'Description', true, true, true, true, true, 4);
        $this->createDataRow($dataTypeProducts, 'stock', 'number', 'Stock', true, true, true, true, true, 5);
        $this->createDataRow($dataTypeProducts, 'price', 'number', 'Price', true, true, true, true, true, 6);
        $this->createDataRow($dataTypeProducts, 'images', 'multiple_images', 'Images', false, true, true, true, true, 7);
        $this->createDataRow($dataTypeProducts, 'created_at', 'timestamp', 'Created At', false, true, true, false, false, 8);
        $this->createDataRow($dataTypeProducts, 'updated_at', 'timestamp', 'Updated At', false, false, false, false, false, 9);
     ...
     * @param int $order
     */
    protected function createDataRow($dataType, $field, $type, $displayName, $required, $browse, $read, $edit, $add, $order)
    {
        $dataRow = $this->dataRow($dataType, $field);
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => $type,
