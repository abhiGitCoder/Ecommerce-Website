...
class DataTypesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!$dataTypeProducts->exists) {
            ...
            // Modify product data type to allow multiple images
            $this->addMultipleImagesFieldToDataType($dataTypeProducts);
        }
    ...
    protected function addMultipleImagesFieldToDataType($dataType)
    {
        $dataType->fields()->create([
            ...
            'details'     => [
                'validation' => [
                    'max'    => 5, // Maximum number of images allowed
                ],
            ],
            'order'       => 6, // Set appropriate order for the field
        ]);
    }
